...
| ATLAS-002 | runtime worker | Sol | in progress | ATLAS-001 | Public-API runtime, model, isolation, and backend feasibility evidence |
| ATLAS-003 | schema worker | Sol | in progress | ATLAS-001 | Provisional report schema, claim derivation, and privacy contract |
| ATLAS-004 | scaffold worker | Terra | in progress | ATLAS-001 | Workspace, package skeleton, baseline CI, and fixture-driven checks |
