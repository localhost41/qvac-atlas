...
test("privacy rules do not reject larger non-token and relative-path supersets", () => {
  for (const value of [
    ...
    "COOKIECUTTERS=secretvalue",
    "CREDENTIALLESS=secretvalue",
    "API_KEYBOARD=secretvalue",
    "API_KEYBOARDS=secretvalue",
    "OPENAI_APIKEYBOARD=secretvalue",
    "TOKENIZERS=secretvalue",
    "privateKeyboard=secretvalue",
    "accessKeystone=secretvalue",
    "secretaryKey=secretvalue",
    "serializerNumber=secretvalue",
    "processorList=secretvalue",
    "TOKENIZER2=secretvalue",
    "COOKIECUTTER3=secretvalue",
    "privateKeyboard2=secretvalue",
    "API2KEYBOARD=secretvalue",
    "apiV2Keyboard=secretvalue",
    "ACCESS2KEYSTONE=secretvalue",
    "MYPRIVATEKEYBOARD=secretvalue",
    "MYACCESSKEYSTONE=secretvalue",
    "MYSECRETKEYBOARD=secretvalue",
    "OPENAIAPIKEYWORD=secretvalue",
    "PRIVATEKEYNOTE=secretvalue",
    "ACCESSKEYBOARDS=secretvalue",
    "APIKEYSTONES=secretvalue",
    "privateKeyboardBackup=secretvalue",
    "apiKeyboardShortcut=secretvalue",
    "accessKeystonePath=secretvalue",
    "APIV2KEYWORD_BACKUP=secretvalue",
    "ACCESSVERSION2KEYSTONE_PATH=x",
    "PRIVATEMONKEY=x",
    "PRIVATEDONKEY=x",
    "PRIVATETURKEY=x",
    "PRIVATEWHISKEY=x",
    ...
    "ACCESSIBILITYKEY=x",
    "APICALKEY=x",
    "secretKeyboardBackup=x",
    "SECRET_KEYBOARD_BACKUP=x",
    "PRIVATE_VIRTUALKEYBOARDBACKUP=x",
    "ACCESS_ARCHITECTUREKEYSTONE=x",
    "API_RESERVEDKEYWORD=x",
    "PRIVATE_EVENTKEYNOTE=x",
    "PRIVATE_KEYBOARDKEYSTONE=x",
    "MACaddressable=secretvalue",
    "IPaddressable=secretvalue",
    "api-keyboard=secretvalue",
    "api.keyboard=secretvalue",
    "version2=secretvalue",
